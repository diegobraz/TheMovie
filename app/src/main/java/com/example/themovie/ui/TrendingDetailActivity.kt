...
import com.example.themovie.ui.adapter.TrendingProductionAdapter
...
class TrendingDetailActivity : AppCompatActivity() {
    ...
    private fun loadInformation() {
        Glide.with(this).load("https://image.tmdb.org/t/p/w500${trending.backdrop_path}").into(binding.tvImageDetail)
